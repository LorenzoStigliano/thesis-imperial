...
def get_weight(dataset, view, model, training_type, shot_n, cv_n, run, student, model_args=None):
    if "ensamble" in model:
        ...
        cv_path = SAVE_DIR_MODEL_DATA+'model_assessment/{}/weights/W_MainModel_{}_{}_{}_run_{}_fixed_init_CV_{}_view_{}_lsp.pickle'.format(model,training_type, dataset, model, run, cv_n, view)
