...
from trainers.lsp_ensemble.lsp_ensamble_2_trainer import cross_validation_2
from trainers.lsp_ensemble.lsp_ensamble_3_trainer import cross_validation_3
from trainers.lsp_ensemble.lsp_ensamble_4_trainer import cross_validation_4
from trainers.lsp_ensemble.lsp_ensamble_5_trainer import cross_validation_5
...
def parrallel_run(run):
    ...
    for dataset_i in datasets_asdnc:
        for view_i in views:
            models = [gcn_student_lsp_ensamble_3_args] 
            for model in models:
                for cv in [3, 5, 10]:
