...
python /homes/ls1121/thesis-imperial/src/main_cross_validation.py --runs 0 1 2 3 4 --n_jobs 1
python /homes/ls1121/thesis-imperial/src/main_cross_validation.py --runs 5 6 7 8 9 --n_jobs 1
