...
gcn_student_emb_ensamble_2_args = {
    ...
    "model_name":"gcn_student_emb_ensamble_2_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
...
gcn_student_emb_ensamble_3_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_emb_ensamble_3_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
...
gcn_student_emb_ensamble_4_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_emb_ensamble_4_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
...
gcn_student_emb_ensamble_5_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_emb_ensamble_5_test_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
...
gcn_student_lsp_ensamble_2_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_lsp_ensamble_2_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
...
gcn_student_lsp_ensamble_3_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_lsp_ensamble_3_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
...
gcn_student_lsp_ensamble_4_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_lsp_ensamble_4_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
...
gcn_student_lsp_ensamble_5_args = {
    ...
    "dropout":0,
    "threshold":"median", # Threshold the graph adjacency matrix. Possible values: no_threshold, median, mean
    "model_name":"gcn_student_lsp_ensamble_5_test",
    "student_type":"gcn",
    "backbone":"gcn",
    "dataset":"gender_data",
    "evaluation_method": "model_assessment", # model selection or model assessment
