...
class GAT_STUDENT_ENSAMBLE(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, alpha, nheads, seed, run, number, total_number):
    ...
    def forward(self, x, adj):
        ...
        if self.is_trained:
            ...
            with open(f"gat_student_lsp_ensamble_{self.total_number}_number_{self.number}_run_{self.run}_W.pickle", 'wb') as f:
