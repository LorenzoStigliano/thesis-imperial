...
def cross_validation_4(model_args, G_list, view, model_name, cv_number, n_students, run=0):
    start = time.time() 
    print("Run : ",run)
    print("--------------------------------------------------------------------------")
...
def train(model_args, train_dataset, val_dataset, students, student_names, threshold_value, model_name, cv, view, cv_number, run=0):
    ...
    train_acc_1, train_acc_2, train_acc_3, train_acc_4 = [], [], [], []
    ...
    validation_loss_1, validation_loss_2, validation_loss_3, validation_loss_4 = [], [], [], []
    ...
    for epoch in range(model_args["num_epochs"]):
        ...
        total_time = 0
        total_loss = 0
        t_loss_1, t_loss_2, t_loss_3, t_loss_4 = 0, 0, 0, 0
        ...
        val_total_loss, val_loss_1, val_loss_2, val_loss_3, val_loss_4, val_loss_teacher_student, val_loss_ensamble_ce, val_ensamble_soft_ce_loss, val_loss_within_student = validate(val_dataset, students, model_args, threshold_value, model_name, teacher_model, teacher_weights)
...
def validate(dataset, students, model_args, threshold_value, model_name, teacher_model, teacher_weights):
    ...
    val_loss_1, val_loss_2, val_loss_3, val_loss_4 = t_loss_1 / len(dataset), t_loss_2 / len(dataset), t_loss_3 / len(dataset), t_loss_4 / len(dataset)
    ...
    return val_total_loss, val_loss_1, val_loss_2, val_loss_3, val_loss_4, val_loss_teacher_student, val_loss_ensamble_ce, val_ensamble_soft_ce_loss, val_loss_within_student
