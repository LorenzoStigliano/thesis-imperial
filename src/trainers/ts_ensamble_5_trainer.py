...
def train(model_args, train_dataset, val_dataset, students, student_names, threshold_value, model_name, cv, view, cv_number, run=0):
    ...
    train_loss_1, train_loss_2, train_loss_3, train_loss_4, train_loss_5 = [], [], [], [], []
    # performance accuracy of each student
    train_acc_1, train_acc_2, train_acc_3, train_acc_4, train_acc_5 = [], [], [], [], []
    ...
    validation_loss_1, validation_loss_2, validation_loss_3, validation_loss_4, validation_loss_5 = [], [], [], [], []
    ...
    for epoch in range(model_args["num_epochs"]):
        ...
        total_time = 0
        total_loss = 0
        t_loss_1, t_loss_2, t_loss_3, t_loss_4, t_loss_5 = 0, 0, 0, 0, 0
        ...
        for _, data in enumerate(train_dataset):
            ...
            student_weights_4 = student_model_3.LinearLayer.weight
            student_weights_5 = student_model_3.LinearLayer.weight
            ...
            t_loss_4+= criterion_soft(ypred_4, y_soft)
            t_loss_5+= criterion_soft(ypred_5, y_soft)
        ...
        train_acc_4.append(metrics.accuracy_score(np.hstack(labels_4), np.hstack(preds_4)))
        train_acc_5.append(metrics.accuracy_score(np.hstack(labels_5), np.hstack(preds_5)))
        ...
        print(f"Train model 4 accuracy: {train_acc_4[-1]}")
        print(f"Train model 5 accuracy: {train_acc_5[-1]}")
        ...
        train_loss_4.append( t_loss_4/ len(train_dataset))
        train_loss_4.append( t_loss_5/ len(train_dataset))
        ...
        val_total_loss, val_loss_1, val_loss_2, val_loss_3, val_loss_4, val_loss_5, val_loss_teacher_student, val_loss_ensamble_ce, val_ensamble_soft_ce_loss, val_loss_within_student = validate(val_dataset, students, model_args, threshold_value, model_name, teacher_model, teacher_weights)
        ...
        validation_loss_4.append(val_loss_4)
        validation_loss_5.append(val_loss_5)
    ...
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args["model_name"]+"/metrics/"+model_name+"_train_acc_student_4.pickle", 'wb') as f:
      pickle.dump(train_acc_5, f)
    ...
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args["model_name"]+"/labels_and_preds/"+model_name+"_train_student_4.pickle", 'wb') as f:
      pickle.dump(simple_r, f)    
    ...
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args['model_name']+"/training_loss/training_loss_student_3_"+model_name+".pickle", 'wb') as f:
      pickle.dump(los_p, f)
    los_p = {'loss':train_loss_5}
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args['model_name']+"/training_loss/training_loss_student_4_"+model_name+".pickle", 'wb') as f:
      pickle.dump(los_p, f)
    ...
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args['model_name']+"/validation_loss/validation_loss_student_3_"+model_name+".pickle", 'wb') as f:
      pickle.dump(los_p, f)
    los_p = {'loss':validation_loss_5}
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args['model_name']+"/validation_loss/validation_loss_student_4_"+model_name+".pickle", 'wb') as f:
      pickle.dump(los_p, f)
...
def validate(dataset, students, model_args, threshold_value, model_name, teacher_model, teacher_weights):
    ...
    # Save labels and predictions of model on test set 
    with open(SAVE_DIR_MODEL_DATA+model_args['evaluation_method']+"/"+model_args["model_name"]+"/labels_and_preds/"+model_name+"_val_student_4.pickle", 'wb') as f:
      pickle.dump(simple_r, f)   

    val_total_loss = total_loss / len(dataset)
    val_loss_1, val_loss_2, val_loss_3, val_loss_4, val_loss_5 = t_loss_1 / len(dataset), t_loss_2 / len(dataset), t_loss_3 / len(dataset), t_loss_4 / len(dataset), t_loss_5 / len(dataset)
    ...
    return val_total_loss, val_loss_1, val_loss_2, val_loss_3, val_loss_4, val_loss_5, val_loss_teacher_student, val_loss_ensamble_ce, val_ensamble_soft_ce_loss, val_loss_within_student
